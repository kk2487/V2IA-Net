...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect', no_antialias=False, no_antialias_up=False, opt=None):
        ...
        self.att_conv1 = AugmentedConv(in_channels=64, out_channels=64, kernel_size=3, dk=40, dv=4, Nh=4, relative=True,stride=1, shape=62)

        self.att_conv_p = AugmentedConv(in_channels=64, out_channels=64, kernel_size=3, dk=40, dv=4, Nh=4, relative=True,stride=1, shape=62)
