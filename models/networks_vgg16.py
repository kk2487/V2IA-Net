...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect', no_antialias=False, no_antialias_up=False, opt=None):
        ...
        ##----------------------------------------------        
        self.conv1 = model.features[0]
        self.relu1 = model.features[1]
        self.conv2 = model.features[2]
        self.relu2 = model.features[3]
        self.maxpool1 = model.features[4]
        ##----------------------------------------------
        self.conv3 = model.features[5]
        self.relu3 = model.features[6]
        self.conv4 = model.features[7]
        self.relu4 = model.features[8]
        self.maxpool2 = model.features[9]

        self.conv5 = model.features[10]
        self.relu5 = model.features[11]
        ...
        #    param.requires_grad = False
        self.conv2_out = nn.Conv2d(ngf, output_nc, kernel_size=7, padding=0)
