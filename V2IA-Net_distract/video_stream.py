...
# 繪製畫面      
        ...
        cv2.rectangle(draw_mat, (800, 0), (920, 40), (255, 255, 255), -1, cv2.LINE_AA)
        ...
        cv2.putText(draw_mat,"Status",(10,30), font,0.6,(255,0,0),2) 
        cv2.putText(draw_mat,": ",(75,35), font, 0.8,(255,0,0),2)
        cv2.putText(draw_mat, distract_output,(95,20), font, 0.7,(255,0,0),2)
        cv2.putText(draw_mat, gan_predict_output,(95,40), font, 0.7,(0,255,0),2)

        cv2.putText(draw_mat, predict_dn_output,(810,30), font, 0.8,(0,0,255),2)
...
# -------------------------------------------------------------------------------
        ...
        cv2.putText(cg_im,"V2IA",(30,30), font, 1,(0,0,255),2)
